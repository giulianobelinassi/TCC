...
Legrenge Polynomials are solutions of the equation:
\begin{equation}
	\frac{\text{d}}{\text{d}x} \left( (1-x²) \frac{\text{d}}{\text{d}x} \phi_n(x) \right) + n\left( n+1 \right) \phi_n(x)
       = 0
\end{equation}

It can be shown that $\phi$ can be obtained with the following recurrence: 
