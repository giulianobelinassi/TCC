...
\begin{figure}[ht]
\centering
\textbf{Average of times of \texttt{Ghmatecd} in \texttt{BrucutuIV}}\par\medskip
...
\begin{figure}[ht]
\centering
\textbf{Average of times of \texttt{Ghmatecd} in \texttt{Venus}}\par\medskip
...
From the figure, we can conclude that for all samples but for the 240 meshes there were speedups. The speedup 
...
\begin{figure}[ht]
\textbf{Average of times of \texttt{Rigid} in \texttt{BrucutuIV}}\par\medskip
\centering
...
\begin{figure}[ht]
\centering
\textbf{Average of times of \texttt{Linsolve} in \texttt{BrucutuIV}}\par\medskip
