...
$25$, $19$, $22$ and $22$ respectively in BrucutuIV. For this sample we can see that a single Tesla K40
...
but there is an interesting observation about the error, as illustrated by Figure $\ref{fig:ghmatecd_brucutuiv_error}$. 
...
lower CPU-GPU memory transfer latency. The logarithm graph at 
