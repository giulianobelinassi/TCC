...
(just removing lines 10 and 11). After that, just use cuBLAS to multiply $Hu$ and $Gb$, and subtract the resulting vectors. Algorithm 
$\ref{interec1_new}$ illustrates this approach.
