...
\section{Introdução}
	...
	mais especificamete na implementação deste algoritmo de forma a explorar 
...
\section{Estado do Trabalho}
	...
	\begin{enumerate}
		...
		\item As subrotinas não haviam distinções claras entre entrada e saída
	...
	decomposição $LU$
	para solução de sistemas lineares de variáveis complexas em paralelo, todos outras
	subrotinas contém descrições do que fazem em seus arquivos correspondentes.
