...
CPUOMP <- cbind(size, "CPU-OMP", c(0.12838128153331732, 2.2240155914022277, 12.135257472735248, 41.76173592719715 ))
GPU <-  cbind(size, "GPU+OMP", c(0.14864438673248515, 0.20578972496829617, 0.427673206096127, 1.05179645329578))
